...
lam_dat <- cbind.data.frame(meds = apply(as.data.frame(BH_fit)[,1:12], 2, median), 
                            lows = apply(as.data.frame(BH_fit)[,1:12], 2, quantile, 0.025), 
                            ups = apply(as.data.frame(BH_fit)[,1:12], 2, quantile, 0.975), 
                            species = rep(1:3, 4), 
